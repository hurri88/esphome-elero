...
methods = ["struct Elero::RxFifoIO", "bool Elero::process_rx(", "void Elero::advance_tx()",
           "void Elero::tx_abort_()", "void Elero::flush_rx()", "void Elero::flush_and_rx()",
           "uint8_t Elero::read_status(", "void Elero::read_buf(", "bool Elero::send_command_internal_("]
if "bool Elero::read_status_stable(" in source:
    methods.append("bool Elero::read_status_stable(")
includes = ["elero_crypto.h", "elero_utils.h", "elero_overflow_logic.h", "elero_tx_logic.h",
